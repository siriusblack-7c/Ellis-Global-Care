  ...
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?q=80&w=1920&auto=format&fit=crop')",
      ...
      >
        <div className="max-w-3xl animate-fade-in">
          <span className="inline-block text-white/90 text-lg mb-4 tracking-wide">
            Welcome to Ellis Global Care
          </span>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Bridging Distances, Delivering Compassionate Care
          </h1>
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            We provide reliable, compassionate, and professionally trained caregivers for your elderly loved ones in their home country, ensuring they receive the best care while you are abroad.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button asChild size="lg" variant="heroSolid" className="min-w-[200px] rounded-full transform transition-all duration-300 hover:translate-y-[-2px]">
              <Link to="/signup">Book a Caregiver</Link>
            </Button>
